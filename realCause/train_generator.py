# python realCause/train_generator.py --data bpic12  --dist "SigmoidFlow" --n_hidden_layers 128 --dim_h 14 --w_transform "Standardize" --y_transform "Normalize" --saveroot "results_realcause" --data_type val --cls_encoding xgboost_combined --num_epochs 2
# python realCause/train_generator.py --data bpic12  --dist "SigmoidFlow" --n_hidden_layers 128 --dim_h 14 --w_transform "Standardize" 
# --y_transform "Normalize" --saveroot "results_realcause" --data_type val --cls_encoding xgboost_combined --num_epochs 10; 
# python realCause/make_datasets.py --data bpic12 --data_type val --cls_encoding xgboost_combined;
...
def get_data(args):
    ...
    if data_name == "lalonde" or data_name == "lalonde_psid" or data_name == "lalonde_psid1":
        ...
        w, t, y = load_bpic(data_name, dataroot=args.dataroot, year=16)
    elif data_name == "bpic17":
        w, t, y = load_bpic(data_name, cls_encoding = args.cls_encoding, dataroot=args.dataroot, data_type=args.data_type, year=17)
    elif data_name == "bpic12":
        w, t, y = load_bpic(data_name, cls_encoding = args.cls_encoding, dataroot=args.dataroot, data_type=args.data_type, year=12)
        # w = w[:, elim_17]
...
def main(args, save_args=True, log_=True):
    ...
    if args.data=="bpic17":
        data_name = "bpic2017"
    elif args.data=="bpic12":
        data_name = "bpic2012"
    # args.saveroot = None
    if args.saveroot=="results_realcause":
        args.saveroot = os.path.join(args.saveroot, data_name, args.data_type)
    else:
        pass
        # args.saveroot = os.path.join(args.saveroot, data_name, args.data_type)
    print("+++++++++++++++++++++++++++++++++")
...
def get_args():
    ...
    # dataset
    parser.add_argument("--data_type", type=str, default="val")  # TODO: fix choices
    parser.add_argument("--cls_encoding", type=str, default="catboost_combined")  # TODO: fix choices

    parser.add_argument("--data", type=str, default="bpic17")  # TODO: fix choices
    parser.add_argument(
